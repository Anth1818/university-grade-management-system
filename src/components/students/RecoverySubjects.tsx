      ...
      case 'already-enrolled':
        return (
          <div className="rounded-md bg-green-50 p-4 text-center">
            ...
            <h3 className="text-lg font-medium text-green-800">¡Inscripción Exitosa!</h3>
            <p className="text-sm text-green-700 mt-1">Te has inscrito correctamente al período de recuperación.</p>
             <Button className="mt-4 mr-4" onClick={() => window.location.href = '/home'}>
              Ir al inicio
              <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
            <Button className="mt-4" onClick={() => window.location.href = '/students/schedules'}>
              Ver horario
              <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
          </div>
